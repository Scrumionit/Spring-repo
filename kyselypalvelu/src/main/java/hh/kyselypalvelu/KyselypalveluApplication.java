...
public class KyselypalveluApplication {
	...
	public CommandLineRunner demo(KyselyRepository kyselyRepository, KysymysRepository kysymysRepository,
		...
		return (args) -> {
			...
			Kysely kysely1 = new Kysely("Hyvinvointikysely",
			...
			Kysymys kysymys3 = new Kysymys("Avoin",
					"Onko viikottainen työmäärä opinnoissasi sopiva? Jos ei ole, kerro miksi ja anna ehdotuksia, kuinka tilannetta voisi parantaa.",
					Arrays.asList(""));
			kysymys3.setKysely(kysely1);
			kysymysRepository.save(kysymys3);

			Kysymys kysymys4 = new Kysymys("Avoin",
					"Miten koet sosiaalisen elämäsi opiskelijana? Onko sinulla tarpeeksi aikaa ystäville ja perheelle?",
					Arrays.asList(""));
			kysymys4.setKysely(kysely1);
			kysymysRepository.save(kysymys4);

			Kysymys kysymys5 = new Kysymys("Avoin",
					"Miten arvioisit mielialaasi viimeisen kuukauden aikana? Onko sinulla ollut stressiä, ahdistusta tai muita mielialan vaihteluita?",
					Arrays.asList(""));
			kysymys5.setKysely(kysely1);
			kysymysRepository.save(kysymys5);

			Kysymys kysymys6 = new Kysymys("Avoin",
					"Onko sinulla riittävästi tukea opinnoissasi, kuten opettajilta, opiskelutovereilta tai muilta tukipalveluilta?",
					Arrays.asList(""));
